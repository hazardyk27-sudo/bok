...
export const BETS_CENTS = [20, 50, 100, 200, 500, 1000, 2000, 5000, 10000, 20000, 50000, 100000, 200000, 500000, 1000000] as const;
...
export const BASE_REFILL_CORE_CHANCE = 0.01;
