...
export const SCRATCH_GRID_COLUMNS = 18;
...
export function interpolateScratchPoints(from: ScratchPoint, to: ScratchPoint, spacing = 0.018): ScratchPoint[] {
