...
import "./styles.css";
import { getSymbolDefinition, PAYTABLE, NORMAL_SYMBOLS, BASE_REEL_CONFIG, ANIMATION, MULTIPLIER_CORE_ARTWORK, NORMAL_PAIR_COPY_CHANCE } from "./config/GameConfig";
...
app.innerHTML = `
  <div class="app-shell ${isLab ? "is-lab" : ""} ${isWinLabelPreview ? "is-label-preview" : ""}">
