        ...
        <div class="roulette-wheel-stage">
           <div class="roulette-wheel-live" data-wheel style="--wheel-band:${rouletteWheelBand}">
            <div class="wheel-rotor">
              ...
              <div class="wheel-number-labels" aria-label="European wheel number order">${EUROPEAN_WHEEL_ORDER.map((number, index) => `<span class="wheel-number-label" data-pocket-index="${index}" style="--pocket-index:${index};--label-flip:180deg"><b>${number}</b></span>`).join("")}</div>
